...
@section('content')
  ...
  <form action="{{ URL::to('unggahExcel') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
         <label class="col-sm-4 control-label" for="import_file">Unggah file Extensi: csv, xls atau xlsx</label>
         <div class="col-sm-3">
...
<div class="row">
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading">Formulir Pengajuan</div>
         <div class="panel-body">
           ...
           <div class="form-group"> <!-- NIK -->
             ...
             <label class="col-sm-2 control-label" for="Photo">Photo Anak</label>
             <div class="col-sm-2">
               <input class="btn-md" type="file" id="Photo" name="Photo">
